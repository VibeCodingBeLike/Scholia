...
pub fn render_works_cited_modal(
    ...
    let max_w = (screen_w * 0.85).clamp(480.0, 680.0);
    ...
    .show(ctx, |ui| {
        let max_content_h = (ui.available_height() - 48.0).max(120.0);
        egui::ScrollArea::vertical()
            ...
            .show(ui, |ui| {
                ...
                if state.editing_entry.source_type == SourceType::Custom {
                    ...
                    let input_w = (ui.available_width() - 170.0).clamp(200.0, 420.0);
                ...
                ui.group(|ui| {
                    ...
                    if preview.trim().is_empty() {
                        ...
                        ui.indent("mla_preview_indent", |ui| {
                            ui.add(
                                egui::Label::new(RichText::new(&preview).color(text_col))
                                    .wrap(),
                            );
                        });
